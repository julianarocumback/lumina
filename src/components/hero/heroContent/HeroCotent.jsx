    ...
    return (
        <div className='text-center flex flex-col gap-4 lg:text-left lg:gap-10'>
            ...
            <div className="flex flex-col gap-2">
                ...
                <Link to='/produto/21'>
                    <motion.button 
                    className="flex justify-center items-center gap-4 relative overflow-hidden rounded-full p-2 w-1/3 bg-gradient-to-r from-[#00639a] to-[#bc004b] py-3 text-white font-semibold text-lg hidden lg:flex hover:cursor-pointer"
