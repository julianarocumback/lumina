export default function ProductList({lista, aumentarQuantidade, diminuirQuantidade, removerDoCarrinho}){
    ...
    return(
        ...
        <div className="w-full h-[calc(100vh-300px)] lg:h-145 lg:rounded-2xl overflow-hidden bg-white shadow-xs overflow-y-auto relative lg:py-0 mt-24 lg:mt-0 border">
