...
export default function FavoritesPreview({favorites}){
    ...
    return (
        <div className='h-fit sm:h-120 xl:h-125 justify-center rounded-3xl md:w-1/3 lg:w-2/5 xl:w-1/3 border border-gray-100 bg-white p-8 shadow-lg flex flex-col gap-4'>
            {/* Header section */}
