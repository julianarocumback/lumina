    ...
    return (
        <div className="flex flex-col gap-1">
            ...
            <div className='flex flex-col gap-2 sm:flex-row sm:justify-between'>
                <input disabled={!isEditingBirthdate} onChange={(e) => handleAddBirthdate(e.target.value)}  type="date" className={`${isEditingBirthdate && 'enabled:outline'} caret-black cursor z-10 w-35 border-gray-500 rounded-xl px-2  lg:border-none`} value={dadosCliente.birthdate} onBlur={handleBirthdateInteracted}/>     
