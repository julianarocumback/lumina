...
export default function HelpCenter(){
    return(
        <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.7}} className='flex flex-col gap-4 h-full ml-15 p-8 pb-22 sm:p-16 sm:pb-30 md:px-32 lg:ml-80 lg:p-16 lg:pt-30 xl:p-32 xl:pb-18 2xl:px-70'>
            {/* CTA */}
