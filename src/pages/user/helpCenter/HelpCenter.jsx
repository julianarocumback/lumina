...
export default function HelpCenter(){
    return(
        <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.7}} className='flex flex-col gap-4 h-full ml-15 p-4 pb-18 sm:p-8 sm:pb-30 md:px-16 lg:ml-80 lg:p-16 lg:pt-30 xl:p-32 xl:pb-18 2xl:px-70'>
            {/* CTA */}
            ...
            <div>
                <div className='flex flex-col items-center gap-8 py-8 sm:flex-row lg:justify-between'>
                    <h2 className='sm:text-lg lg:text-xl font-semibold'>Histórico de atendimento</h2>
                    {/* Filter tabs */}
