                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        {dadosCliente.cartoes.map(cartao => {
                            return (
                                <div className="h-40 gap-2 w-full justify-center rounded-2xl bg bg-[radial-gradient(at_0%_0%,#000,transparent_100%),radial-gradient(at_100%_100%,#000,transparent_90%),radial-gradient(at_0%_0%,#000,transparent_80%)] shadow-lg p-4 flex flex-col">
