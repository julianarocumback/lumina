        ...
        <div className="flex flex-col gap-8 lg:gap-8 pt-20 pb-5 lg:py-30 pl-20 pr-5 lg:pl-100 lg:pr-20 h-full">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="h-35 w-full justify-center rounded-2xl bg bg-[radial-gradient(at_0%_0%,#000,transparent_100%),radial-gradient(at_100%_100%,#000,transparent_90%),radial-gradient(at_0%_0%,#000,transparent_80%)] shadow-lg p-4 flex flex-col">
                            <div className="flex justify-between">
                            <div className="text-white"><i class="fa-brands fa-cc-visa"></i></div>
                            <span className="text-xs font-bold text-gray-400">Gold</span>
                            </div>

                            <div className="bg-yellow-500 w-6 rounded-md h-4"></div>
                            <div className="self-center text-white font-semibold -tracking-tighter">•••• •••• •••• 4242</div>
                            <div className="flex justify-between text-white">
                                <div className="">
                                    <span className="text-[8px] font-semibold text-gray-400">Nome</span>
                                    <p className="text-xs font-semibold">Ana Silva dos Santos</p>
                                </div>
                                <div>
                                    <span className="text-[8px] font-semibold text-gray-400">Validade</span>
                                    <p className="text-xs font-semibold">05/26</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <button className="h-35 w-full justify-center items-center gap-2 rounded-2xl p-4 flex flex-col border-dashed border border-gray-300">
